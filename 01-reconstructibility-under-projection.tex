...
The paper develops a dependency-status account---preserved, reconstructible, traceable, and opaque---and binds those structural support conditions to sets of licensed epistemic operations: direct inference, bounded reconstruction, trace or retrieval, qualification, routing, or refusal of the requested form. It separates informational support from operational permission and distinguishes the dependency status that actually obtains from the status assessed by a bounded reasoner and the operation ultimately selected. This yields separate notions of assessment fidelity and governance compliance and identifies unsupported promotion---for example, treating traceability as reconstructibility, policy selection as evidential support, or procedural preservation as procedural license---as a common structural failure. The resulting framework treats structural insufficiency as a constraint on available epistemic operations rather than merely a reason to lower confidence, while retaining a second-order limit on self-certifying admissibility procedures.
