...
The central novelty of this framework is to treat admissibility not as correctness, confidence, caution, or policy compliance, but as a structural licensing relation between a claim, the representation from which it is made, and the distinctions required to support it. Under projection, a response may be fluent, plausible, and locally coherent while still being inadmissible because the operative representation no longer preserves, exposes, or boundedly reconstructs the distinctions on which the claim depends.
...
For normative or evaluative queries, \(q\) should be read as model-relative: the
 framework analyzes whether a declared evaluative target is preserved under projection, not whether the target has a mind-independent unique value.
